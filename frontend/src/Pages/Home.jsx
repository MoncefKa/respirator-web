...
import Btn_backTop from '../Components/Btn_backTop'
        ...
        <div>
            <div className="text-gray-700  bg-white antialiased">
                ...
                <section className="container mx-auto px-6 p-10" >
                    <h2 className="text-4xl font-bold text-center text-gray-800 mb-20">Our Project</h2>
                    ...
                    <div className="flex items-center flex-wrap mb-20">
                        <div className="w-full md:w-1/2">
                            <img className="rounded-lg h-90 w-full" src={Fablab} alt="use the force" />
                        </div>
                        <div className="w-full md:w-1/2 pl-10">
                            <h4 className="text-3xl text-gray-800 font-bold mb-3 text-center">Fablab</h4>
                            <p className="text-gray-600 mb-8 capitalize text-center">Fab Lab, or digital fabrication laboratory, is a place to play, to create, to mentor and to invent : a place for learning and innovation.
                                Fab Labs provide access to the environment, <br />the skills, the materials and the advanced technology to allow anyone anywhere to make (almost) anything.</p>
                        </div>
                    </div>
                ...
                <div className="h-full ">
                    <div>
                        <h1 className="text-4xl font-bold mb-10 uppercase text-center">Our Team</h1>
                    </div>
                    <div className="h-full flex justify-between p-8">
                        <div className="w-full max-w-sm  rounded-lg ">
                            ...
                            <div className="flex flex-col items-center pb-10">
                                ...
                                <span className="text-sm text-gray-500 dark:text-gray-400">Cyber Security Researcher </span>
                        ...
                        <div className="w-full max-w-sm rounded-lg ">
                            ...
                            <div className="flex flex-col items-center pb-10">
                                ...
                                <span className="text-sm text-gray-500 dark:text-gray-400">VR/AR Developer Researcher</span>
                                <div className="flex mt-4 space-x-3 md:mt-6">
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="w-full max-w-sm rounded-lg ">
                            ...
                            <div className="flex flex-col items-center pb-10">
                                ...
                                <span className="text-sm text-gray-500 dark:text-gray-400">PhD Researcher</span>
                                <div className="flex mt-4 space-x-3 md:mt-6">
                                </div>
                            </div>
                        </div>
                        <div className="w-full max-w-sm rounded-lg ">
                            ...
                            <div className="flex flex-col items-center pb-10">
                                <img className="w-24 h-24 mb-3 rounded-full shadow-lg" src={rebhi} alt="dont" />
                                <h5 className="mb-1 text-xl font-medium text-gray-900 dark:gray-600">Rebhi MOHAMED</h5>
                                <span className="text-sm text-gray-500 dark:text-gray-400">Electrical Engineer</span>
                                <div className="flex mt-4 space-x-3 md:mt-6">
                                </div>
                            </div>
                        </div>
                        <div className="w-full max-w-sm rounded-lg ">
                            ...
                            <div className="flex flex-col items-center pb-10">
                                ...
                                <span className="text-sm text-gray-500 dark:text-gray-400"> Data Scientist Researcher </span>
                                <div className="flex mt-4 space-x-3 md:mt-6">
                                </div>
                            </div>
                        </div>
