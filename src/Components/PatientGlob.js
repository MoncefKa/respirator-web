...
function PatientGlob() {
  return (
    <div>
      <div class="sm:px-0">
        <div class=" sm:mb-0 grid grid-rows-1 w-112  h-64 py-2   gap-8    sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          ...
          <div class="relative group bg-gray-900 py-2 flex justify-center  sm:py-20 px-4 flex flex-col space-y-3 items-center cursor-pointer rounded-md hover:bg-gray-900/80 hover:smooth-hover">
            <img
