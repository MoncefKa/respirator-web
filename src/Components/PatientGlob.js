...
import hatim from '../assets/images/patient1.jpeg'

function PatientGlob() {
  return (
    <div>
      <div class="sm:px-0">
        <div class=" sm:mb-0 grid py-10 px-10  gap-20 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <div class="group bg-gray-900/50  py-20 px-4   flex flex-col space-y-2 items-center cursor-pointer rounded-md hover:bg-gray-900/40 hover:smooth-hover">
            <a
