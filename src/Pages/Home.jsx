        ...
        <div>
            ...
            <body class="text-gray-700  bg-white antialiased" >
                ...
                <div class=" h-screen  bg-hero bg-cover bg-center  bg-no-repeat bg-fixed" >
                    <div class="container p-64 text-center mx-auto  opacity-100">
                        ...
                        <button class="bg-white font-bold rounded-full py-4 px-8 shadow-lg uppercase tracking-wider hover:border-transparent hover:text-blue-500 hover:bg-gray-800 transition-all">access your dashboard </button>
                    </div>
                </div>
